...
class CategoriesListView(ListView):
    model=Categories
    template_name="admin_page/categories_list.html"
    paginate_by=3
...
class CategoriesCreate(SuccessMessageMixin,CreateView):
    ...
    fields="__all__"
    template_name="admin_page/category_create.html"

class CategoriesUpdate(SuccessMessageMixin,UpdateView):
    model=Categories
    success_message="Category Updated!"
    fields="__all__"
    template_name="admin_page/category_update.html"

#subcategories
class SubCategoriesListView(ListView):
    model=SubCategories
    template_name="admin_page/sub_category_list.html"
    paginate_by=3
...
class SubCategoriesCreate(SuccessMessageMixin,CreateView):
    model=SubCategories
    success_message="SubCategory Has Been Added!"
    fields="__all__"
    template_name="admin_page/sub_category_create.html"

class SubCategoriesUpdate(SuccessMessageMixin,UpdateView):
    model=SubCategories
    success_message="SubCategory Updated!"
    fields="__all__"
    template_name="admin_page/sub_category_update.html"

class MerchantUserListView(ListView):
    model=MerchantUser
    template_name="admin_page/merchant_list.html"

class MerchantUserCreateView(SuccessMessageMixin,CreateView):
    template_name="admin_page/merchant_create.html"
    model=CustomUser
...
class MerchantUserUpdateView(SuccessMessageMixin,UpdateView):
    template_name="admin_page/merchant_update.html"
    model=CustomUser
    fields= ["first_name", "last_name", "email", "username", "password"]
